...
Parmi des résultats de $vp$ rapportées dans la littérature, on compare les résultats correspondant aux conditions des essais DCLT réalisés (Table \ref{tab:comparatifs_}).
...
La Figure présente les données sur la forme de graphe.
