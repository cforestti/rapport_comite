...
En plus, on constate que les courbes CLT vertes pour les éprouvettes plus denses (SHM2 et SFM2) présentent une augmentation des contraintes. On attribue ceci à la proximité du fond de l'éprouvette. Cela est en accord avec les résultats en chambre de calibration de cite{Salgado1998}. Ceux-ci ont montré que l'augmentation de la résistance statique attribuée aux effects de bords sont plus expressives pour de sables plus dense (ayant un comportement dilatant).
